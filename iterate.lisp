...
(eval-when (:compile-toplevel :execute)
  ...
  (defun sharpL-reader (stream subchar n-args)
    ...
    (let* ((form #+cst (eclector.reader:read stream t nil t) #-cst (read stream t nil t))
  ...
  #-cst (setf *readtable* (copy-readtable *readtable*))
  #+cst (setf eclector.readtable:*readtable* (eclector.readtable:copy-readtable eclector.readtable:*readtable*))
